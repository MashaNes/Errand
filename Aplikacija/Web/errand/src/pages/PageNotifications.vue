<template>
    ...
    <div class="page-wrapper" v-else>
        <div v-for="notification in Notifications" :key="notification.id" class="notification-div">
            <NotificationAndroid :notification="notification" v-if="notification.type_id == 0 || notification.type_id == 3 || notification.type_id == 4"/>
            <NotificationNew :notification="notification" v-if="notification.type_id != 0 && notification.type_id != 3 && notification.type_id != 4 && notification.opened == false"/>
            <NotificationRead :notification="notification" v-if="notification.type_id != 0 && notification.type_id != 3 && notification.type_id != 4 && notification.opened == true"/>
        </div>
